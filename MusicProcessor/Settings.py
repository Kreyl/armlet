...
assert 0 < LOCATION_ID_START < LOCATIONS_ID_END < CHARACTER_ID_START < CHARACTER_ID_END < INTENTION_ID_START < INTENTION_ID_END < EMOTION_FIX_ID_START < EMOTION_FIX_ID_END < 2 ** 15
