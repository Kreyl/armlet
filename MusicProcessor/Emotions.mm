	...
	<node TEXT="Фон">
		<node TEXT="Негатив">
			...
			<node TEXT="Неуверенность">
				<node TEXT="Озабоченность">
					<node TEXT="Напряженность">
						<node TEXT="Истерика"/>
					</node>
				</node>
				<node TEXT="Сомнение"/>
		...
		<node TEXT="Позитив">
			...
			<node TEXT="Довольство">
				<node TEXT="Гордость"/>
				<node TEXT="Удовлетворение"/>
			</node>
			<node TEXT="Любопытство">
				<node TEXT="Интерес"/>
				<node TEXT="Увлеченность">
					<node TEXT="Азарт"/>
			...
			<node TEXT="Приязнь">
				<node TEXT="Симпатия">
					<node TEXT="Привязанность">
						<node TEXT="Любовь"/>
					</node>
					<node TEXT="Вожделение"/>
				</node>
				<node TEXT="Умиление"/>
			</node>
			<node TEXT="Надежда">
				<node TEXT="Предвкушение">
					<node TEXT="Вера"/>
					<node TEXT="Уверенность"/>
				</node>
			</node>
			<node TEXT="Покой">
