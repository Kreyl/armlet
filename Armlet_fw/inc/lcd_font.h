...
0x00, 0x06, 0x7e, 0x50, 0xac, 0xfc,  // 0x0e - нота II.
0x00, 0x54, 0x38, 0x6c, 0x38, 0x54, // 0x0f - солнце (круг с расходящимися лучами).
0x00, 0x00, 0xfe, 0x7c, 0x38, 0x10, // 0x10 - толстая стрелка вправо.
0x00, 0x10, 0x38, 0x7c, 0xfe, 0x00,  // 0x11 - толстая стрелка влево.
0x00, 0x28, 0x6c, 0xfe, 0x6c, 0x28, // 0x12 - тонкая стрелка вверх-вниз.
0x00, 0x00, 0xfa, 0x00, 0xfa, 0x00,  // 0x13 - два восклицательных знака.
0x00, 0x60, 0x90, 0xfe, 0x80, 0xfe, // 0x14 - символ "Пи".
0x00, 0x44, 0xb2, 0xaa, 0x9a, 0x44, // 0x15 - символ параграфа.
0x00, 0x06, 0x06, 0x06, 0x06, 0x00, // 0x16 - широкое подчеркивание.
0x00, 0x28, 0x6d, 0xff, 0x6d, 0x28, // 0x17 - тонкая стрелка вверх-вниз с подчеркиванием.
0x00, 0x20, 0x60, 0xfe, 0x60, 0x20, // 0x18 - тонкая стрелка вверх.
0x00, 0x08, 0x0c, 0xfe, 0x0c, 0x08, // 0x19 - тонкая стрелка вниз.
0x00, 0x10, 0x10, 0x7c, 0x38, 0x10, // 0x1a - тонкая стрелка вправо.
0x00, 0x10, 0x38, 0x7c, 0x10, 0x10, // 0x1b - тонкая стрелка влево.
0x00, 0x1e, 0x02, 0x02, 0x02, 0x02, // 0x1c - символ отступа.
0x00, 0x10, 0x7c, 0x10, 0x7c, 0x10, // 0x1d - тонкая стрелка влево-вправо.
0x00, 0x0c, 0x3c, 0xfc, 0x3c, 0x0c, // 0x1e - толстая стрелка вверх.
0x00, 0xc0, 0xf0, 0xfc, 0xf0, 0xc0, // 0x1f - толстая стрелка вниз.
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x20 - пробел (пустое знакоместо).
0x00, 0x00, 0x60, 0xfa, 0x60, 0x00, // 0x21 - восклицательный знак.
0x00, 0xe0, 0xc0, 0x00, 0xe0, 0xc0, // 0x22 - двойная кавычка.
0x00, 0x24, 0x7e, 0x24, 0x7e, 0x24, // 0x23 - решетка.
0x00, 0x24, 0xd4, 0x56, 0x48, 0x00, // 0x24 - доллар.
0x00, 0xc6, 0xc8, 0x10, 0x26, 0xc6, // 0x25 - процент.
0x00, 0x6c, 0x92, 0x6a, 0x04, 0x0a, // 0x26 - амперсанд.
0x00, 0x00, 0xe0, 0xc0, 0x00, 0x00, // 0x27 - апостроф.
0x00, 0x00, 0x7c, 0x82, 0x00, 0x00, // 0x28 - открывающая скобка.
0x00, 0x00, 0x82, 0x7c, 0x00, 0x00, // 0x29 - закрывающая скобка.
0x00, 0x10, 0x7c, 0x38, 0x7c, 0x10, // 0x2a - звездочка (умножение).
0x00, 0x10, 0x10, 0x7c, 0x10, 0x10, // 0x2b - плюс.
0x00, 0x00, 0x07, 0x06, 0x00, 0x00, // 0x2c - запятая.
0x00, 0x10, 0x10, 0x10, 0x10, 0x10, // 0x2d - тире.
0x00, 0x00, 0x06, 0x06, 0x00, 0x00, // 0x2e - точка.
0x00, 0x04, 0x08, 0x10, 0x20, 0x40, // 0x2f - слеш слева-направо ('/').
...
0x00, 0x1c, 0x22, 0x22, 0x22, 0x14, // 0xf1 - 'с'.

0x00, 0x20, 0x20, 0x3e, 0x20, 0x20, // 0xf2 - 'т'.

0x00, 0x39, 0x05, 0x06, 0x3c, 0x00, // 0xf3 - 'у'.

0x00, 0x18, 0x24, 0x3e, 0x24, 0x18, // 0xf4 - 'ф'.

0x00, 0x36, 0x08, 0x08, 0x36, 0x00, // 0xf5 - 'х'.

0x00, 0x3e, 0x02, 0x02, 0x3e, 0x03, // 0xf6 - 'ц'.

0x00, 0x30, 0x08, 0x08, 0x08, 0x3e, // 0xf7 - 'ч'.

0x00, 0x3e, 0x02, 0x3e, 0x02, 0x3e, // 0xf8 - 'ш'.

0x00, 0x3e, 0x02, 0x3e, 0x02, 0x3f, // 0xf9 - 'щ'.

0x30, 0x20, 0x3e, 0x0a, 0x0a, 0x04, // 0xfa - 'ъ'.

0x00, 0x3e, 0x0a, 0x0a, 0x04, 0x3e, // 0xfb - 'ы'.

0x00, 0x3e, 0x0a, 0x0a, 0x0a, 0x04, // 0xfc - 'ь'.

0x00, 0x14, 0x22, 0x2a, 0x2a, 0x1c, // 0xfd - 'э'.

0x00, 0x3e, 0x08, 0x1c, 0x22, 0x1c, // 0xfe - 'ю'.

0x00, 0x12, 0x2c, 0x28, 0x28, 0x3e // 0xff - 'я'.
};
