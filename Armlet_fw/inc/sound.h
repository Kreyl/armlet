...
private:
    ...
    inline void XCS_Lo()   { PinClear(VS_GPIO, VS_XCS); DELAY() }
    inline void XCS_Hi()   { PinSet(VS_GPIO, VS_XCS); DELAY() }
    inline void XDCS_Lo()  { PinClear(VS_GPIO, VS_XDCS); DELAY() }
