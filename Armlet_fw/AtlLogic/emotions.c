...
Reason_t reasons[] = {
 ...
 /*  89 */ { "FC89", 40, 0, 9 },        /* les */
	...
	// Mist sources
 /*  90 */ { "M90", 200, 0, 4 },        /* tuman */
 /*  91 */ { "M91", 200, 0, 4 },        /* tuman */
 /*  92 */ { "M92", 200, 0, 4 },        /* tuman */
 /*  93 */ { "M93", 200, 0, 4 },        /* tuman */
 /*  94 */ { "M94", 200, 0, 4 },        /* tuman */
 /*  95 */ { "M95", 200, 0, 4 },        /* tuman */
 /*  96 */ { "M96", 200, 0, 4 },        /* tuman */
 /*  97 */ { "M97", 200, 0, 4 },        /* tuman */
 /*  98 */ { "M98", 200, 0, 4 },        /* tuman */
 /*  99 */ { "M99", 200, 0, 4 },        /* tuman */
 /* 100 */ { "M100", 200, 0, 4 },       /* tuman */
	// end of mist sources
