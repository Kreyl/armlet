...
//        {"vv", 0, 130, 0, bSoundDownCheck, buttonGetState, bSoundDownChange}
        {"\xec\xf3\xe7\xfb\xea\xe0", 0, 1, 20, bChangeMelodyCheck, buttonGetState, bChangeMelody},
        {"^^", 0, 95, 58, bSoundUpCheck, buttonGetState, bSoundUpChange},
        {"vv", 0, 95, 96, bSoundDownCheck, buttonGetState, bSoundDownChange},
